...
def load_cifar100(args):
    ...
    original_train = dsets.CIFAR100(root='./data/CIFAR100', train=True, download=True, transform=transforms.ToTensor())
    ...
    model.load_state_dict(torch.load(os.path.expanduser('./partial_models/weights/cifar100.pt')))
